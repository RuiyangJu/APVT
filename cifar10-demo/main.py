...
class Solver(object):
    ...
    def load_model(self):
        ...
        # self.model = models.resnet101().to(self.device)
        # self.model = models.resnext50_32x4d().to(self.device)
        # self.model = models.resnext101_32x8d().to(self.device)
        # self.model = models.wide_resnet50_2().to(self.device)
        # self.model = models.wide_resnet101_2().to(self.device)
